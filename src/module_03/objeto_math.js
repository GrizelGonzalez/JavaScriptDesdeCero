/* OBJETO MATH 
-> Es un objeto estático, tenemos que usar su nombre para utilizarlo.
...
console.log(Math.pow(3,3)) //es base y exponente//
console.log(Math.round(Math.random()*100));
//console.log(Math.random() * (max-min)+min);
console.log(Math.random(Math.random() * (10-5)+5));
